"""
Created on Tue Nov  7 18:48:42 2017
...
word_vectors = KeyedVectors.load_word2vec_format('glove.42B.300d.txt', binary=False)
...
def main():
  ...
  for value in analogy.values():
    sum+=len(value)
  print("Accuracy using Glove embeddings is:",((acc/sum)*100)) #printing the final accuracy values
